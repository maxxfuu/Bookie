...
export const AnimatedSpan = ({
  ...
  // Render-time state adjustment (not an effect): start as soon as the
  // sequence hands this item the active slot.
  if (
    sequence !== null &&
    itemIndex !== null &&
...
export const TypingAnimation = ({
  ...
  useEffect(() => {
    if (hasSequence || started || (startOnView && !isInView)) return

    const startTimeout = setTimeout(() => setStarted(true), delay)
    return () => clearTimeout(startTimeout)
  }, [delay, startOnView, isInView, started, hasSequence])
